...
namespace LOGI.Framework.Toolkit.Core.Reflection.Dynamic
{
    ...
    public class ElasticObject : DynamicObject, IElasticHierarchyWrapper, INotifyPropertyChanged
    {
        ...
        public override bool TryGetIndex(GetIndexBinder binder, object[] indexes, out object result)
        {
            ...
            else if ((indexes.Length == 1) && indexes[0] is Func<object,bool>)
            {
                var filter = indexes[0] as Func<object, bool>;
