...
{  
    ...
    /// </summary>
    [ConfigurationElementType(typeof(VerboseDatabaseTraceListenerDataOrderPaymentTransactions))]
    public class VerboseDatabaseTraceListenerOrderPaymentTransactions : FormattedTraceListenerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="VerboseDatabaseTraceListenerOrderPaymentTransactions"/>.
        /// </summary>
        ...
        public VerboseDatabaseTraceListenerOrderPaymentTransactions(
            Database database,
        ...
        {
            ExecuteWriteLogStoredProcedure(0, string.Empty, string.Empty, string.Empty, string.Empty, 0, 5, TraceEventType.Information, string.Empty, DateTime.Now, string.Empty,
        ...
        /// <summary>
        /// Declare the supported attributes for <see cref="VerboseDatabaseTraceListenerOrderPaymentTransactions"/>
        /// </summary>
        ...
        private int ExecuteWriteLogStoredProcedure(int eventId, string vposSalesTransactionId, string basketWebRefID, string affiliateCode, string userName, int sessionId, int priority, TraceEventType severity, string title, DateTime timeStamp,
                                                    ...
                                                    string managedThreadName, string win32ThreadId, string message, Database db)
        {
            ...
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.AffiliateCode, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, affiliateCode);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.UserName, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, userName);
            db.AddInParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.SessionId, DbType.Int32, sessionId);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.VPOSSalesTransactionId, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, vposSalesTransactionId);
            db.AddParameter(cmd, "BasketWebRefID", DbType.String, 512, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, basketWebRefID);
        ...
        private int ExecuteWriteLogStoredProcedure(LogEntry logEntry, Database db, DbTransaction transaction)
        {
            ...
            var userName = "";
            int sessionId = 0;
            var vposSalesTransactionId = "";

            #region LogEntry.ExtendedProperties
            if (logEntry.ExtendedProperties != null && logEntry.ExtendedProperties.Count > 0)
            {
                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.BasketWebRefID))
                {
                    basketWebRefID = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.BasketWebRefID].ToString();
                    //logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.BasketWebRefID);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.AffiliateCode))
                {
                    affiliateCode = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.AffiliateCode].ToString();
                    //logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.AffiliateCode);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.UserName))
                {
                    userName = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.UserName].ToString();
                    //logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.UserName);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.SessionId))
                {
                    Int32.TryParse(logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.SessionId].ToString(), out sessionId);
                    //logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.SessionId);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.VPOSSalesTransactionId))
                {
                    vposSalesTransactionId = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.VPOSSalesTransactionId].ToString();
                    //logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.VPOSSalesTransactionId);
                }
            } 
            #endregion
            ...
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.AffiliateCode, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, affiliateCode);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.UserName, DbType.String, 50, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, userName);
            db.AddInParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.SessionId, DbType.Int32, sessionId);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrderPaymentTransactionsLogData.VPOSSalesTransactionId, DbType.String, 50, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, vposSalesTransactionId);
            db.AddParameter(cmd, "BasketWebRefID", DbType.String, 512, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, basketWebRefID);
