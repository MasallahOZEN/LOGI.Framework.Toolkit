...
{  
    ...
    /// </summary>
    [ConfigurationElementType(typeof(VerboseDatabaseTraceListenerDataReservation))]
    public class VerboseDatabaseTraceListenerReservation : FormattedTraceListenerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="VerboseDatabaseTraceListenerReservation"/>.
        /// </summary>
        ...
        public VerboseDatabaseTraceListenerReservation(
            Database database,
        ...
        {
            ExecuteWriteLogStoredProcedure(0,false, string.Empty, string.Empty, string.Empty, 0, 5, TraceEventType.Information, string.Empty, DateTime.Now, string.Empty,
        ...
        /// <summary>
        /// Declare the supported attributes for <see cref="VerboseDatabaseTraceListenerReservation"/>
        /// </summary>
        ...
        private int ExecuteWriteLogStoredProcedure(int eventId,bool itemType, string basketWebRefID, string affiliateCode, string userName, int sessionId, int priority, TraceEventType severity, string title, DateTime timeStamp,
                                                    ...
                                                    string managedThreadName, string win32ThreadId, string message, Database db)
        {
            ...
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.AffiliateCode, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, affiliateCode);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.UserName, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, userName);
            db.AddInParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.SessionId, DbType.Int32, sessionId);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.BasketWebRefID, DbType.String, 512, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, basketWebRefID);
            db.AddInParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.ItemType, DbType.Boolean, itemType);
        ...
        private int ExecuteWriteLogStoredProcedure(LogEntry logEntry, Database db, DbTransaction transaction)
        {
            ...
            {
                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.BasketWebRefID))
                {
                    basketWebRefID = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.BasketWebRefID].ToString();
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.BasketWebRefID);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.AffiliateCode))
                {
                    affiliateCode = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.AffiliateCode].ToString();
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.AffiliateCode);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.UserName))
                {
                    userName = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.UserName].ToString();
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.UserName);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.SessionId))
                {
                    Int32.TryParse(logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.SessionId].ToString(), out sessionId);
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.SessionId);
                }
                
                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.ItemType))
                {
                    Boolean.TryParse(logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.ItemType].ToString(), out itemType);
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.ItemType);
                }
            } 
            #endregion
            ...
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.AffiliateCode, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, affiliateCode);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.UserName, DbType.String, 50, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, userName);
            db.AddInParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.SessionId, DbType.Int32, sessionId);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.ResevationsLogData.BasketWebRefID, DbType.String, 512, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, basketWebRefID);
            db.AddInParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.ItemType, DbType.Boolean, itemType);
