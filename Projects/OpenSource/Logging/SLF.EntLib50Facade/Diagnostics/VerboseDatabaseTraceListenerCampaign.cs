...
{  
    ...
    /// </summary>
    [ConfigurationElementType(typeof(VerboseDatabaseTraceListenerDataCampaign))]
    public class VerboseDatabaseTraceListenerCampaign : FormattedTraceListenerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="VerboseDatabaseTraceListenerCampaign"/>.
        /// </summary>
        ...
        public VerboseDatabaseTraceListenerCampaign(
            Database database,
        ...
        /// <summary>
        /// Declare the supported attributes for <see cref="VerboseDatabaseTraceListenerCampaign"/>
        /// </summary>
        ...
        private int ExecuteWriteLogStoredProcedure(LogEntry logEntry, Database db, DbTransaction transaction)
        {
            ...
            if (logEntry.ExtendedProperties != null && logEntry.ExtendedProperties.Count > 0)
            {
                ...
                {
                    if (logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.WebAppLogData.AffiliateCode]!=null)
                    {
                ...
                {
                    if (logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.WebAppLogData.UserName]!=null)
                    {
                ...
                {
                    var sessId = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.WebAppLogData.SessionId];

                    if (sessId!=null)
                    {
                        Int32.TryParse(sessId.ToString(), out sessionId);
                    }
