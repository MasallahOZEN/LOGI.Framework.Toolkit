...
{  
    ...
    /// </summary>
    [ConfigurationElementType(typeof(VerboseDatabaseTraceListenerDataOrders))]
    public class VerboseDatabaseTraceListenerOrders : FormattedTraceListenerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="VerboseDatabaseTraceListenerOrders"/>.
        /// </summary>
        ...
        public VerboseDatabaseTraceListenerOrders(
            Database database,
        ...
        /// <summary>
        /// Declare the supported attributes for <see cref="VerboseDatabaseTraceListenerOrders"/>
        /// </summary>
                ...
                try
                {
                    using (DbTransaction transaction = connection.BeginTransaction())
                    {
                        try
                        {
                            ...
                            transaction.Commit();
                            logEntry.ExtendedProperties["LogId"] = logID;
                        }
                        catch
                        {
                                                    ...
                                                    string managedThreadName, string win32ThreadId, string message, Database db)
        {
            ...
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.AffiliateCode, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, affiliateCode);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.UserName, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, userName);
            db.AddInParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.SessionId, DbType.Int32, sessionId);
        ...
        private int ExecuteWriteLogStoredProcedure(LogEntry logEntry, Database db, DbTransaction transaction)
        {
            ...
            {
                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.BasketWebRefID))
                {
                    basketWebRefID = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.BasketWebRefID].ToString();
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.BasketWebRefID);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.AffiliateCode))
                {
                    affiliateCode = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.AffiliateCode].ToString();
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.AffiliateCode);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.UserName))
                {
                    userName = logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.UserName].ToString();
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.UserName);
                }

                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.SessionId))
                {
                    Int32.TryParse(logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.SessionId].ToString(), out sessionId);
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.SessionId);
                }
                
                if (logEntry.ExtendedProperties.ContainsKey(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.ItemType))
                {
                    Boolean.TryParse(logEntry.ExtendedProperties[ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.ItemType].ToString(), out itemType);
                    logEntry.ExtendedProperties.Remove(ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.ItemType);
                }
            } 
            #endregion
            ...
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.AffiliateCode, DbType.String, 60, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, affiliateCode);
            db.AddParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.UserName, DbType.String, 50, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Default, userName);
            db.AddInParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.SessionId, DbType.Int32, sessionId);
            db.AddInParameter(cmd, ConstantHelper.TravelPortalCore.LogColumns.OrdersLogData.ItemType, DbType.Boolean, itemType);
